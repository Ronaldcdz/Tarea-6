    ...
    <ion-page class="body-background">
        ...
        <ion-content :fullscreen="true" class="body-background">
            ...
            <div class="ion-padding">
                <ion-list>
                    <h1>Adivina tu genero escribiendo tu nombre !!!!</h1>
                    <ion-item>
            ...
            <div class="ion-padding" v-show="showAge">
                <template v-if="gender == 'male'">
                    <div class="maleBackground">
                        <h4>Usted es un hombre !!</h4>
                    </div>
                </template>
                <template v-else>
                    <div class="femaleBackground">
                        <h4>Usted es una mujer !!</h4>
...
import { IonButtons, IonContent, IonHeader, IonMenuButton, IonItem, IonList, IonPage, IonTitle, IonToolbar, IonGrid, IonRow, IonCol, IonCard, IonCardContent, 
    IonCardHeader, IonCardTitle, IonInput, IonButton } from '@ionic/vue';

export default {

    components: {
        IonButtons, IonContent, IonHeader, IonMenuButton, IonPage, IonTitle, IonToolbar, IonGrid, IonRow, IonCol,
        IonCard, IonCardContent, IonCardHeader, IonCardTitle, IonInput, IonItem, IonList, IonButton
    },
    ...
    methods: {
        async genderGenerator(){
            ...
            if(this.name){
                const response = await fetch(`https://api.genderize.io/?name=${this.name.toLowerCase()}`)
